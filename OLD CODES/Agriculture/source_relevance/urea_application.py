...
from .census_intensity import aggregate_c21_heads_by_nuts2
...
def load_grass_livestock_omega_for_cfg(cfg: dict[str, Any], root: Path) -> pd.Series:
    ...
    field_map_path = resolve_path(
        root,
        census.get("c21_field_map_json", "Agriculture/config/emission_factors/c21_census_field_map.json"),
    )
    field_map: dict[str, Any] = json.loads(field_map_path.read_text(encoding="utf-8"))
