...
from PROXY_V2.core.area_weights import combined_S_shipping, normalize_W_per_cams_cell
...
from PROXY_V2.dataset_loaders.load_emodnet import load_emodnet
from PROXY_V2.dataset_loaders.load_osm import load_osm, rasterize_osm
from PROXY_V2.visualizers.area_weights_map import write_shipping_area_weights_map
...
def build(
    ...
    *,
    ...
    if area_weights:
        ...
        osm_polygons = load_osm(repo_root / osm_filepath.replace("\\", "/"), cams_cells, osm_cfg)
