...
from PROXY_V2.core.area_weights import combined_S_industry_group, normalize_W_per_cams_cell
...
from PROXY_V2.visualizers.area_weights_map import write_b_industry_area_weights_debug_map
...
def build(
    ...
    *,
    ...
    if point_matching:
        ...
        log.info(f"B_Industry point matching: {n_eprtr} CAMS→E-PRTR, {n_yes}/{len(matches)} matched.")
