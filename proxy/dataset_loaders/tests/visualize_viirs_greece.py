...
Run from repo root::
    ...
    python proxy/dataset_loaders/tests/visualize_viirs_greece.py
    python proxy/dataset_loaders/tests/visualize_viirs_greece.py --list
    python proxy/dataset_loaders/tests/visualize_viirs_greece.py --metric frp
"""
...
def main() -> None:
    ...
    p.add_argument(
        ...
        "--output",
        type=Path,
        default=_REPO / "proxy/dataset_loaders/tests/output/viirs_greece_fires.png",
    )
    args = p.parse_args()
