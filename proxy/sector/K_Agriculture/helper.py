...
from proxy.core.alias import gamma_split_manure
from proxy.dataset_loaders.load_corine import load_corine, load_corine_weighted_l3
from proxy.dataset_loaders.load_lucas import load_lucas_points, lucas_rate_mean_raster
from proxy.dataset_loaders.load_nuts2 import load_nuts2_polygons, rasterize_nuts2_ids
...
def build_clc_fallback_lookup(
    ...
    *,
    ...
    from proxy.writers.debug_dump import ClcRateCell
...
def lucas_lc1_rate_points(
    ...
    *,
    ...
    from proxy.dataset_loaders.load_lucas import load_lucas_points
...
def build_lc1_rate_surface(
    ...
    *,
    ...
    from proxy.dataset_loaders.load_lucas import lucas_rate_mean_raster
